...
<form method="post" name="writeform" action="/myWeb/board/updatePro.do?pageNum=${pageNum }" onsubmit="return writeSave()">
	<table width="400" border="1" cellspacing="0" bgcolor="${bodyback_c }" align="center">
	<tr>
	...
	<tr>
		...
		<input type="button" value="목록보기" onclick="document.location.href='/myWeb/board/list.do?pageNum=${pageNum}'"></td>
	</tr>
	</table>
</form>
