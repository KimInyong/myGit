...
public class StudentDAO {
	...
	//DB에 회원가입에 적었던 값을 넣어준다
		...
		//StudentVO객체에 셋팅값을 넣어주고 VO를 RegProcAction에서 
		//세션 아이디와 비교해서 맞다면 VO값을 받아온다
		...
		//DB와 비교해서 아이디와 비밀번호가 같으면 1을 리턴해주고 틀리면 0을 리턴해주는 메서드구현
		//LoginProcAction session에 id값을 넣고
		//아이디나 비밀번호가 없다면 check값 request에 세팅
